    ...
    return (
        <span className='relative '>
            <input
                ...
                name={name}
                className="min-w-full bg-white border border-gray-300 text-gray-900 text-[14px] text-center rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-3"
